...
class ThemeProvider extends ChangeNotifier {
  ...
  ThemeData get themeData {
    ...
    final textTheme = const TextTheme(
      ...
      bodyColor:
          brightness == Brightness.dark ? Colors.white : const Color(0xFF1B262C),
      displayColor:
          brightness == Brightness.dark ? Colors.white : const Color(0xFF1B262C),
    );
    ...
    return ThemeData(
      ...
      scaffoldBackgroundColor:
          brightness == Brightness.dark ? const Color(0xFF0F1B1D) : const Color(0xFFF4F5F0),
      appBarTheme: AppBarTheme(
        backgroundColor:
            brightness == Brightness.dark ? const Color(0xFF162326) : Colors.white,
      ...
      inputDecorationTheme: InputDecorationTheme(
        ...
        filled: true,
        fillColor: brightness == Brightness.dark ? const Color(0xFF1C2A2E) : Colors.white,
